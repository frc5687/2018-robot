 ...
 */
public class TrajectoryController extends SendableBase implements PIDInterface, Sendable {
    ...
    private class TrajectoryTask extends TimerTask {
        private TrajectoryController m_controller;

        TrajectoryTask(TrajectoryController controller) {
            requireNonNull(controller, "Given TrajectoryController was null");
    ...
    public TrajectoryController(double Kp, double Ki, double Kd, double Kf, PIDSource source,
        ...
        m_controlLoop.schedule(new TrajectoryTask(this), 0L, (long) (m_period * 1000));
     ...
     */
    @SuppressWarnings("ParameterName")
    public TrajectoryController(double Kp, double Ki, double Kd, PIDSource source, PIDOutput output,
                         double period) {
