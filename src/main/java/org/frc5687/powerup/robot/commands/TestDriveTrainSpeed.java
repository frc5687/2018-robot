...
public class TestDriveTrainSpeed extends Command {
    ...
    public TestDriveTrainSpeed(DriveTrain driveTrain, double distance, double speed, String debug) {
        this(driveTrain, distance, speed, false, true, 0, debug);
    }

    public TestDriveTrainSpeed(DriveTrain driveTrain, double distance, double speed, long maxMillis, String debug) {
        this(driveTrain, distance, speed, false, true, 1000, maxMillis, debug);
    }

    public TestDriveTrainSpeed(DriveTrain driveTrain, double distance, double speed, boolean usePID, boolean stopOnFinish, long maxMillis, String debug) {
     ...
     */
    public TestDriveTrainSpeed(DriveTrain driveTrain, double distance, double speed, boolean usePID, boolean stopOnFinish, double angle, long maxMillis, String debug) {
        requires(driveTrain);
        this.speed = speed;
...
//        angleController.setPID(SmartDashboard.getNumber("DB/Slider 0", 0), SmartDashboard.getNumber("DB/Slider 1", 0), SmartDashboard.getNumber("DB/Slider 2", 0));
    ...
    protected void execute() {
        ...
        _i++;
        SmartDashboard.putNumber("AutoDrive/_i", _i);
    }
