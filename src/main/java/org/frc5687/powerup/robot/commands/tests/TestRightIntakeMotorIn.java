...
public class TestRightIntakeMotorIn extends Command {
    private Intake _intake;
    private PDP _pdp;
    private long _timeout = 1000;
    private long _endtime;

    public TestRightIntakeMotorIn(Intake intake, PDP pdp) {
        _intake = intake;
        _pdp = pdp;
    }

    public TestRightIntakeMotorIn(Intake intake, PDP pdp, long timeout) {
        _intake = intake;
        _pdp = pdp;
        _timeout = timeout;
    }
    ...
    protected void initialize() {
        ...
        DriverStation.reportError("Running right intake in for one second", false);
    }
